                ...
                <div className='container mt-5'>
                    <div className="row">
                        <div className="col">
                            ...
                            <div className="mb-2">
                                <img className='avatar' src={data[0].img_mentor} alt={data[0].mentor} />
                    ...
                    <div className="row">
                        <div className="col-6">
                        <iframe width="560" height="315" src={data[0].video} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
                            <p>{data[0].detalle}</p>
                        </div>
                        <div className="col-6">
